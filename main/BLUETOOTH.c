...
const char *tag = "Bluetooth"; /*Para imprimir en pantalla diferentes mensajes*/
...
{ /*Cuando se conecta el dispositivo, y se envia un mensaje se llama a esta funcion*/
    switch (event)
    {
    ...
    case ESP_SPP_DATA_IND_EVT:
        ...
        /*Nos permite mandar una respuesta mediante bluetooth desde el mobil*/
...
void app_main(void)
{
    ...
    /*Inicializar la partida de control de bluet*/
